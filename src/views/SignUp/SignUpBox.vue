<template>
  <div class="signUpBox">
    ...
    <input
      ...
      placeholder="사이트 URL"
      @keyup="() => regCheck(regs.urlReg02,this.site_url)"
    />
    <div
...
import { idReg, pwReg, phReg, nameReg, engNameReg, telReg, urlReg02 } from '../../config/reg';
export default {
  name: 'SignUpBox',
  mounted: function() {
    window.scrollTo({
  ...
  data() {
    return {
      regs: { idReg, pwReg, phReg, nameReg, engNameReg, telReg, urlReg02 },
